...
A server & client application to play Youtube videos in sync on multiple devices at the same time. Built with React, Redux, Node.js & Socket.IO.
...
```shell
$ git clone https://github.com/bramvdg/react-youtube-sync.git
